...
{use Authenticatable, CanResetPassword;
    ...
    protected $fillable = ['name','email','password','m_canuipe',
                'm_nudiver','m_nutipdo','m_caprnom','m_casenom','m_caprape',
                'm_caseape','m_fenacim','m_nuedada','m_catipsa','m_catisex',
                'm_cadirec','m_nucociu','m_catelfi','m_camovil','m_nuofici',
                'm_nucocar','m_caestad','m_canivel','m_feinici','m_fevenci','m_feactco',
                'm_causreg','m_causact','m_caprenu','m_capreed','m_capreel',
                'm_capreex','m_capap01','m_capap02','m_capap03','m_capap04',
                'm_capap05','m_capap06','m_capap07','m_capap08','m_capap09',
                'm_capap10','m_capap11','m_capap12','m_capap13','m_capap14',
                'm_capap15','m_capap16','m_capap17','m_capap18','m_capap19',
                'm_capap20','m_capap21','m_capap22','m_capap23','m_capap24',
                'm_capap25','m_nucoemp'];
