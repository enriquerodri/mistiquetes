...
class Capmterm extends Model
{
    ...
    */
    ...
    //Buscador de Terminales de transporte por id - LLAVE (BUSQUEDA EXACTA)
    public function scopeNuipe($query,$m_canuipe){
        return $query->where('m_canuipe','LIKE',$m_canuipe);
    }

    //Buscador de Terminales de transporte por razon social
    public function scopeNombre($query,$nombre){
        return $query->where('m_canombr','LIKE','%'.$nombre.'%');
    }

    //Filtro de Terminales de transporte por ciudades (BUSQUEDA EXACTA)
    public function scopeNombre_ciudad($query,$m_nucociu){
        return $query->where('m_nucociu','LIKE',$m_nucociu);
    }

    //Buscador de Terminales de transporte por nombre contacto
