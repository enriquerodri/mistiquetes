...
class Capmtido extends Model
{
	//Administrador Tipos de documentos de identificación
	protected $table = "capmtido";
	protected $primaryKey = 'm_nucodig';
	protected $fillable = ['m_canombr','m_cacodna','m_catipos','m_caestad',
							'm_causreg','m_causact'];
