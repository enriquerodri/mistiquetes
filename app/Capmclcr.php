...
class Capmclcr extends Model
{
	//Administrador Clientes crédito
	protected $table = "capmclcr";
    ...
    */
    ...
    //Buscador de Clientes creditos empresariales por id - LLAVE (BUSQUEDA EXACTA)
    public function scopeNuipe($query,$m_canuipe){
        return $query->where('m_canuipe','LIKE',$m_canuipe);
    }

    //Buscador de Clientes creditos empresariales por razon social
    public function scopeNombre($query,$nombre){
        return $query->where('m_canombr','LIKE','%'.$nombre.'%');
    }

    //Filtro de Clientes creditos empresariales por ciudades (BUSQUEDA EXACTA)
    public function scopeNombre_ciudad($query,$m_nucociu){
        return $query->where('m_nucociu','LIKE',$m_nucociu);
    }

    //Buscador de Clientes creditos empresariales por nombre contacto
