...
class Capmseve extends Model
{
	//Administrador Asociados - Conductores - Propietarios 
	protected $table = "capmseve";
    ...
    //Relación con el modelo Documentos Vehiculos
    public function segurosvehiculos(){
        return $this->belongsTo('App\Capmseve','m_nuidper');
    }
