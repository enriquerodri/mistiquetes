...
class DivisionesController extends Controller
{
    ...
    public function index(Request $request){
        if(Auth::user()->m_capap10=="SI"){
            ...
            //  DIVISIONES
            $divisiones = Capmdivi::nombre($request->m_canombr)->
            ...
            //  VISTA
            return view('admin.programador.divisiones.index',
                compact('divisiones','usuarios','m_canombr_filtro',
    ...
    public function exportarpdf(Request $request){
        ...
        $divisiones = Capmdivi::nombre($this->m_canombr_filtro)->
