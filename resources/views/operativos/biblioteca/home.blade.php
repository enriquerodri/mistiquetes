...
<!-- INICIO MENU PAGINA BIBLIOTECA (OPERATIVOS) -->
@extends('template')

@section('content')
  <section>
    <!-- MENU BIBLIOTECA -->
    @include('partials.menu-biblioteca')
    <div class="section-content">
      <h2 class="icon-box-title text-uppercase text-center"><a class="">Mi biblioteca de consulta</a></h2>
      <!-- 26-08-2018 -->
...
@endsection
<!-- FIN MENU PAGINA BIBLIOTECA (OPERATIVOS) -->
