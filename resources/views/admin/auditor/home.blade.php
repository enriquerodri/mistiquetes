...
<!-- INICIO MENU PAGINA AUDITOR (ADMINISTRATIVOS) -->
@extends('template')
...
@section('content')
  <section>
    ...
    <div class="section-content">
      <h2 class="icon-box-title text-uppercase text-center"><a class="">Mi auditor</a></h2>
      <!-- 26-08-2018 -->
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="text-center">
                  <!-- OPCION 01 -->
                  <a>
                    <img src="{{ asset('images/flaticon-png/small/mi_auditor_eventos_01.jpg') }}" width="90" alt="">
                  </a>
                  <h4 class="icon-box-title text-uppercase"><a class="">Eventos</a></h4>
                  <h5><a class="" href="{{ route('auditoria-eventos') }}">Consultar</a></h5>
                </div>
              </div>
              <div class="col-md-3">
                <div class="text-center">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="text-center">
                  ...
                  <h4 class="icon-box-title text-uppercase"><a class="">Productividad</a></h4>
                  <h4 class="text-center" style="background: #ecf0f1;"><p>ANALISIS PRODUCTIVIDAD</p></h4>
                  <h5><a class="" href="#">Conductores</a></h5>
                  <h5><a class="" href="#">Oficinas</a></h5>
                  <h5><a class="" href="#">Rutas y trayectos</a></h5>
...
@endsection
<!-- FIN MENU PAGINA AUDITOR (ADMINISTRATIVOS) -->
