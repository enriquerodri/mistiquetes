...
//Descripción:      Página principal: Tipos de documento
//Actualizaciones
	...
	<body>
		...
		<header>
			<div style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:12px; text-align: center;">
				CONSULTA TIPOS DE DOCUMENTO<br>
			</div>
			<div style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:14px; text-align: letf;">
		...
		<footer>
			<hr style="color: #2d3436; height: -1px;"/>
				CONSULTA TIPOS DE DOCUMENTO - Página <span class="pagenum"></span>
			<hr style="color: #2d3436; height: -1px;"/>
		</footer>
		<!-- FIN PIE -->
		...
		<table class="table table-striped table-hover table-bordered">
			...
			<thead>
				<tr class="text-center">
					<td style="text-align: center; background-color: #5CB85C; color: white; font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">Tipo de documento
					</td>
			...
			<tbody>
				@foreach($tiposdocumentos as $tipodocumento)
					<tr>
						<td class="text-left" style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$tipodocumento->m_canombr}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$tipodocumento->m_cacodna}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$tipodocumento->m_caestad}}
						</td> 
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$tipodocumento->created_at}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$tipodocumento->usuario_registra->name}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$tipodocumento->updated_at}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$tipodocumento->usuario_actualiza->name}}
						</td>
					</tr>
				@endforeach
			</tbody>
		...
		<div class="modal-footer">
			...
			<div style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif;font-size:10px; text-align: left;">
				<br>
				<b>Total Registros: {{$tiposdocumentos->Count()}}</b><br>
