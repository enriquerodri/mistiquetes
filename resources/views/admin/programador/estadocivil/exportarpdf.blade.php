	...
	<body>
		...
		<footer>
			<hr style="color: #2d3436; height: -1px;"/>
				CONSULTA ESTADO CIVIL - Página <span class="pagenum"></span>
			<hr style="color: #2d3436; height: -1px;"/>
		</footer>
		<!-- FIN PIE -->
		...
		<table class="table table-striped table-hover table-bordered">
			...
			<thead>
				<tr class="text-center">
					<td style="text-align: center; background-color: #5CB85C; color: white; font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">Estado civil
					</td>
			...
			<tbody>
				@foreach($estadosciviles as $estadocivil)
					<tr>
						<td class="text-left" style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$estadocivil->m_canombr}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$estadocivil->m_cacodna}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$estadocivil->m_caestad}}
						</td> 
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$estadocivil->created_at}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$estadocivil->usuario_registra->name}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$estadocivil->updated_at}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$estadocivil->usuario_actualiza->name}}
						</td>
					</tr>
				@endforeach
			</tbody>
		...
		<div class="modal-footer">
			...
			<div style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif;font-size:10px; text-align: left;">
				<br>
				<b>Total Registros: {{$estadosciviles->Count()}}</b><br>
