	...
	<body>
		...
		<footer>
			<hr style="color: #2d3436; height: -1px;"/>
				CONSULTA DOCUMENTOS - Página <span class="pagenum"></span>
			<hr style="color: #2d3436; height: -1px;"/>
		</footer>
		<!-- FIN PIE -->
		...
		<table class="table table-striped table-hover table-bordered">
			...
			<thead>
				<tr class="text-center">
					<td style="text-align: center; background-color: #5CB85C; color: white; font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">Documento
					</td>
					<td style="text-align: center; background-color: #5CB85C; color: white; font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">Descripción
					</td>
					<td style="text-align: center; background-color: #5CB85C; color: white; font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">Personas
					</td>
					<td style="text-align: center; background-color: #5CB85C; color: white; font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">Vehículos pasajeros
					</td>
					<td style="text-align: center; background-color: #5CB85C; color: white; font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">Vehículos carga
					</td>
					<td style="text-align: center; background-color: #5CB85C; color: white; font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">Remolques
					</td>
			...
			<tbody>
				@foreach($documentos as $documento)
					<tr>
						<td class="text-left" style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$documento->m_canombr}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$documento->m_cadescr}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$documento->m_caapper}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$documento->m_caapvpa}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$documento->m_caapvca}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$documento->m_caaprem}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$documento->m_cacodna}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$documento->m_caestad}}
						</td> 
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$documento->created_at}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$documento->usuario_registra->name}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$documento->updated_at}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$documento->usuario_actualiza->name}}
						</td>
					</tr>
				@endforeach
			</tbody>
		...
		<div class="modal-footer">
			...
			<div style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif;font-size:10px; text-align: left;">
				<br>
				<b>Total Registros: {{$documentos->Count()}}</b><br>
