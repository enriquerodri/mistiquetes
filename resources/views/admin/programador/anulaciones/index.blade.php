...
//Descripción:      Página principal: Motivos anulaciones
//Actualizaciones
...
@include('partials.menu-programador')
	<div class="container text-center">
		...
		<div class="row text-center">
			...
			<div class="col-md-3">
				...
				<form action="{{ route('anulaciones.index') }}" method="get">
					<!-- ORDENAMIENTO -->
					...
					<div class="col-md-5 text-left" style="padding-left: 0px">
						<button 
							...
							</i>&nbsp&nbsp&nbsp(&nbsp&nbspTotal Registros {{count($anulaciones)}} de {{$anulaciones->total()}}&nbsp&nbsp)
						</button>
					</div>
				</form>
			</div>
			<!-- PAGINADO SUPERIOR -->
			@if($anulaciones->total()>160)
		...
		<table class="table table-striped table-hover table-bordered">
			...
			<thead>
				<tr class="text-center encabezadotb">
					<td>Editar</td>
					<td>Mótivo anulación</td>
					<td>Aplica a</td>
					<td>Anular documentos relacionados</td>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-header" style="background-color: #3498db">
					...
					<h3 class="modal-title" id="myModalLabel" style="text-align: center;"><span class="glyphicon glyphicon-check"></span>&nbsp&nbspCREAR MOTIVO ANULACION
					</h3>
				</div>
				<!-- Contenido -->
		...
		<div id="modaleditar" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-header" style="background-color: #3498db">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h3 class="modal-title" id="myModalLabel" style="text-align: center;"><span class="glyphicon glyphicon-edit"></span>&nbsp&nbspEDITANDO MOTIVO ANULACION
							...
							<div class="modal-footer">
								<div class="text-center">
									...
									@if(Auth::user()->m_capreel=="SI")
										<a onclick="eliminar({{$anulacion->m_nucodig}})" id="btn btn-danger" class="btn btn-danger" data-toggle="modal" data-target="#modaleditar" title="" data-placement="right"><i class="fa fa-trash" style="font-size:18px;text-shadow:2px 2px 4px #000000;" ></i>&nbsp&nbspEliminar
										</a>
									@else
	...
	<div id="modalprocedimientos" class="modal fade">
	    ...
	    <div class="modal-content">
			...
			<div class="modal-header" style="background-color: #3498db">
				...
				<h3 class="modal-title" id="myModalLabel" style="text-align: center;"><span class="glyphicon glyphicon-list-alt"></span>&nbsp&nbspPROCEDIMIENTOS MOTIVO ANULACION
				</h3>
			</div>
			<!-- Contenido -->
			<div class="modal-body">
	...
	<div id="modalfiltros" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
		    ...
		    <div class="modal-content">
				...
				<div class="modal-header" style="background-color: #3498db">
					...
					<h3 class="modal-title" id="myModalLabel" style="text-align: center;"><span class="glyphicon glyphicon-filter"></span>&nbsp&nbspFILTROS MOTIVO ANULACION
					</h3>
				</div>
				<!-- Contenido -->
				<div class="modal-body">
			    	...
			    	<div class="container-fluid">
			    		...
			    		<div class="row form-group">
			    			<label class="col-sm-3 text-right control-label">Motivo:</label>
			    			<div class="col-md-9">
						...
						<div class="row form-group">
							<label class="col-sm-3 text-right control-label">Anular Documentos relacionados:</label>
							<div class="col-sm-9">
								<div class="icon-addon addon-md">
			    			...
			    			<div class="col-md-9">
								<div class="icon-addon addon-md">
									{!! Form::select('m_canombr_campos', [
											'llave_compuesta'=>'Predeterminado (Motivo + Aplica a + Anular documentos relacionados)',
											'm_canombr'=>'Nombre',
											'm_caaplic'=>'Documento al que aplica',
											'm_caanure'=>'Anular documentos relacionados',
				...
				<div class="row">
					...
					<div class="col-md-2 text-right" style="padding-left: 9px">
						...
						@if(Auth::user()->m_capreep=="SI")
							<form action="{{ route('anulaciones-pdf') }}" method="get">
								<!-- ORDENAMIENTO -->
								<!-- ASCENDENTE - DESCENDENTE -->
								<input type="hidden" name="m_canombr_ordene"
												value="<?php if(isset($_GET['m_canombr_ordene']))
					...
					<div class="col-md-3 text-left" style="padding-left: 25px">
						...
						@if(Auth::user()->m_capreex=="SI")
							<form action="{{ route('anulaciones-excel') }}" method="get">
								<!-- ORDENAMIENTO -->
								<!-- ASCENDENTE - DESCENDENTE -->
								<input type="hidden" name="m_canombr_ordene"
												value="<?php if(isset($_GET['m_canombr_ordene']))
	...
	<script>
		...
		var anc_bar_pro = 0;
		var tot_reg_hal = {{$anulaciones->total()}};
		var tot_reg_pen = {{$anulaciones->total()}};
