...
@include('partials.menu-programador')
	<div class="container text-center">
		...
		<div class="row text-center">
			...
			<div class="col-md-3">
				...
				<form action="{{ route('paises.index') }}" method="get">
					<!-- ORDENAMIENTO -->
					...
					<div class="col-md-5 text-left" style="padding-left: 0px">
						<button 
							...
							</i>&nbsp&nbsp&nbsp(&nbsp&nbspTotal Registros {{count($paises)}} de {{$paises->total()}}&nbsp&nbsp)
						</button>
					</div>
				</form>
			</div>
		    ...
		    <div class="modal-content">
				...
				<div class="modal-body">
			    	...
			    	<div class="container-fluid">
			    		...
			    		<div class="row form-group">
			    			<label class="col-sm-3 text-right control-label">Nombre oficial:</label>
			    			<div class="col-md-9">
			    		...
			    		<div class="row form-group">
			    			<label class="col-sm-3 text-right control-label">Capital:</label>
			    			<div class="col-md-9">
			    		...
			    		<div class="row form-group">
			    			<label class="col-sm-3 text-right control-label">Moneda:</label>
			    			<div class="col-md-9">
			    		...
			    		<div class="row form-group">
			    			<label class="col-sm-3 text-right control-label">Código Internacional:</label>
			    			<div class="col-md-9">
			    				<div class="icon-addon addon-md">
			    					{!! Form::text('m_cacodna',null, [
										'class'=>'form-control',
										'id'=>'m_cacodna',
										'placeholder'=>'CÓDIGO ITERNACIONAL...',
			    			...
			    			<div class="col-md-9">
								<div class="icon-addon addon-md">
									{!! Form::select('m_canombr_campos', [
											'm_canombr'=>'Nombre',
											'm_canomof'=>'Nombre oficial',
											'm_canomca'=>'Nombre capital',
											'm_camoned'=>'Moneda',
				...
				<div class="row">
					<div class="col-md-6 text-right" style="padding-right: 0px">
						...
						@if(Auth::user()->m_capreep=="SI")
							<form action="{{ route('paises-pdf') }}" method="get">
								<!-- ORDENAMIENTO -->
								<!-- ASCENDENTE - DESCENDENTE -->
								<input type="hidden" name="m_canombr_ordene"
												value="<?php if(isset($_GET['m_canombr_ordene']))
								...
								<!-- FILTROS -->
								<input type="hidden" name="m_canombr" value="<?php if(isset($_GET['m_canombr'])) echo $_GET['m_canombr']; ?>">
								<input type="hidden" name="m_canomof" value="<?php if(isset($_GET['m_canomof'])) echo $_GET['m_canomof']; ?>">
								<input type="hidden" name="m_canomca" value="<?php if(isset($_GET['m_canomca'])) echo $_GET['m_canomca']; ?>">
								<input type="hidden" name="m_camoned" value="<?php if(isset($_GET['m_camoned'])) echo $_GET['m_camoned']; ?>">
								<input type="hidden" name="m_cacodna" value="<?php if(isset($_GET['m_cacodna'])) echo $_GET['m_cacodna']; ?>">
								<input type="hidden" name="m_caestad" value="<?php if(isset($_GET['m_caestad'])) echo $_GET['m_caestad']; ?>">
								<input type="hidden" name="m_causreg" value="<?php if(isset($_GET['m_causreg'])) echo $_GET['m_causreg']; ?>">
								<input type="hidden" name="m_causact" value="<?php if(isset($_GET['m_causact'])) echo $_GET['m_causact']; ?>">
					...
					<div class="col-md-6 text-left" style="padding-left: 8px">
						...
						@if(Auth::user()->m_capreex=="SI")
							<form action="{{ route('paises-excel') }}" method="get">
								<!-- ORDENAMIENTO -->
								<!-- ASCENDENTE - DESCENDENTE -->
								<input type="hidden" name="m_canombr_ordene"
												value="<?php if(isset($_GET['m_canombr_ordene']))
	...
	<!-- INICIO MODAL: RELACION DEPARTAMENTOS POR PAIS -->
	<div id="modalpais_departamentos" class="modal fade">
  	  <div class="modal-dialog modal-lg">
	    <div class="modal-content">
	    	<!-- Encabezado -->
			<div class="modal-header" style="background-color: #3498db">
				...
				<h3 class="modal-title" id="myModalLabel" style="text-align: center;"><span class="glyphicon glyphicon-list-alt"></span>&nbsp&nbspPAIS - DEPARTAMENTOS
				</h3>
			</div>
			<!-- Contenido -->
			<div class="modal-body">
	...
	<!-- FIN MODAL: RELACION DEPARTAMENTOS POR PAIS -->
	...
	<script>
		...
		var anc_bar_pro = 0;
		var tot_reg_hal = {{$paises->total()}};
		var tot_reg_pen = {{$paises->total()}};
