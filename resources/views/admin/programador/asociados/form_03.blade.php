...
<h4 class="modal-title"
	...
	<span class="fa fa-file-text-o"></span>&nbsp&nbspDATOS CONDUCTOR
</h4>
<!-- CONDUCTOR -->
<div class="form-group">
	...
	<div class="col-sm-4">
		<div class="icon-addon addon-md">
			{!! Form::select('m_cacondu', ['SI'=>'SI','NO'=>'NO'], null, [
					'class'=>'form-control',
					'id'=>'m_cacondu',
					'required'=>'required',
					'placeholder'=>'CONDUCTOR',
					'title'=>"Lista de selección Conductor  [ SI - NO ]"
				])
			!!}
			<label for="m_cacondu" class="glyphicon glyphicon-search" rel="tooltip" title="Seleccionar [ SI - NO ]">
			</label>
		</div>
	</div>
	...
	<div class="col-sm-3">
		<div class="icon-addon addon-md">
			...
			!!}
			<label for="m_fevinco" class="glyphicon glyphicon-calendar" rel="tooltip" title="Fecha de Vinculación">
			</label>
		</div>
	</div>
