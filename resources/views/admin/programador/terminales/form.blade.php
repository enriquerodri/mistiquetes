...
//Descripción:      Crear - Editar: Terminales de transporte
//Actualizaciones
...
<!-- DIRECCION -->
<div class="form-group">
	<label class="col-sm-2 control-label" style="margin-bottom: -20px; margin-top: -20px;">Dirección:</label>
</div>
<div class="form-group">
	<a class="col-sm-2 control-label"
		...
		href="#"
		target="_blank">
		<img src="{{ asset('images/flaticon-png/small/ubicacion_regional_20.png') }}"
			 width="40"
			 alt=""
...
<div class="form-group" style="display:none;">
	<a class="col-sm-2 control-label"
		...
		href="#"
		target="_blank">
		<img src="{{ asset('images/flaticon-png/small/ubicacion_regional_20.png') }}" width="30" alt=""><b>&nbsp&nbspRuta:</b>
	</a>
	<div class="col-sm-10">
		<div class="icon-addon addon-lg">
...
function datosCiudad(id)
{
	...
	$.ajax({
        ...
        success:function(data){
			...
			//0- DIRECCION
			//1- NOMBRE
			var dato_01 = $("#modalcrear #m_canombr").val()
			////6- MAPA DIRECCION
			$("#modalcrear #m_camapas").val(dato_01);
