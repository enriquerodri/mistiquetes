...
//Descripción:      Página principal: ipos de combustible para clasificación vehículos
//Actualizaciones
...
<html>
	<head>
		<!-- INICIO TITULO -->
		<title>Tipos de combustible vehículo</title>
	...
	<body>
		...
		<header>
			<div style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:12px; text-align: center;">
				CONSULTA TIPOS DE COMBUSTIBLE VEHICULO<br>
			</div>
			<div style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:14px; text-align: letf;">
		...
		<footer>
			<hr style="color: #2d3436; height: -1px;"/>
				CONSULTA TIPOS DE COMBUSTIBLE VEHICULO - Página <span class="pagenum"></span>
			<hr style="color: #2d3436; height: -1px;"/>
		</footer>
		<!-- FIN PIE -->
		...
		<table class="table table-striped table-hover table-bordered">
			...
			<thead>
				<tr class="text-center">
					<td style="text-align: center; background-color: #5CB85C; color: white; font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">Tipo combustible vehículo
					</td>
			...
			<tbody>
				@foreach($tiposcombustibles as $tipocombustible)
					<tr>
						<td class="text-left" style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$tipocombustible->m_canombr}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$tipocombustible->m_cacodna}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$tipocombustible->m_caestad}}
						</td> 
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$tipocombustible->created_at}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$tipocombustible->usuario_registra->name}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$tipocombustible->updated_at}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$tipocombustible->usuario_actualiza->name}}
						</td>
					</tr>
				@endforeach
			</tbody>
		...
		<div class="modal-footer">
			...
			<div style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif;font-size:10px; text-align: left;">
				<br>
				<b>Total Registros: {{$tiposcombustibles->Count()}}</b><br>
