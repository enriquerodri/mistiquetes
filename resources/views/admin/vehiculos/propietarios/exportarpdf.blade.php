...
//Descripción:      Página principal: Página principal: Propietarios vehículos
//Actualizaciones
	...
	<body>
		...
		<footer>
			<hr style="color: #2d3436; height: -1px;"/>
				CONSULTA DE PROPIETARIOS - Página <span class="pagenum"></span>
			<hr style="color: #2d3436; height: -1px;"/>
		</footer>
		<!-- FIN PIE -->
		...
		<table class="table table-striped table-hover table-bordered">
			...
			<thead>
				<tr class="text-center">
					...
					<td style="text-align: center; background-color: #5CB85C; color: white; font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">Propietario
					</td>
			...
			<tbody>
				@foreach($propietarios as $propietario)
					<tr>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$propietario->m_canuipe}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$propietario->m_canombr}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$propietario->m_cadirec}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$propietario->ciudades->m_canombr}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$propietario->m_catelfi}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$propietario->m_camovil}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$propietario->m_cadacon}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$propietario->m_cacodna}}
						</td>
						<td style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size:10px;">{{$propietario->m_caestad}}
						</td>
					</tr>
				@endforeach
			</tbody>
		...
		<div class="modal-footer">
			...
			<div style="font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif;font-size:10px; text-align: left;">
				<br>
				<b>Total Registros: {{$propietarios->Count()}}</b><br>
