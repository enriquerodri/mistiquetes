...
//Descripción:      Menu pagina Consultas
//Actualizaciones
...
<!-- INICIO MENU PAGINA CONSULTAS (ADMINISTRATIVOS) -->
@extends('template')

@section('content')
  <section>
    <!-- MENU CONSULTAS -->
    @include('partials.menu-consultas')
    <div class="section-content">
      <h2 class="icon-box-title text-uppercase text-center"><a class="">Mis Consultas</a></h2>
      <!-- 26-08-2018 -->
...
@endsection
<!-- FIN MENU PAGINA CONSULTAS (ADMINISTRATIVOS) -->
